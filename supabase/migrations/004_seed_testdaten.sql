...
INSERT INTO artikel (id, artikelnummer, titel, beschreibung, marke_id, kategorie_id, preis_brutto, steuersatz, aktiv, slug) VALUES
  ('a1000000-0000-4000-8000-000000000001'::uuid, 'DAI-SEN-001', 'Daikin Sensira', 'Das Daikin Sensira Wandgerät bietet hervorragendes Preis-Leistungs-Verhältnis und zuverlässige Kühlung mit minimalem Energieverbrauch.', 'b1000000-0000-0000-0000-000000000001'::uuid, 'c1000000-0000-0000-0000-000000000001'::uuid, 899.00, 19.00, true, 'daikin-sensira'),
  ('a1000000-0000-4000-8000-000000000002'::uuid, 'DAI-PER-001', 'Daikin Perfera', 'Perfera sorgt für erstklassige Luftqualität und optimalen Komfort dank 3D-Luftstrom und fortschrittlicher Luftreinigung.', 'b1000000-0000-0000-0000-000000000001'::uuid, 'c1000000-0000-0000-0000-000000000001'::uuid, 1199.00, 19.00, true, 'daikin-perfera'),
  ('a1000000-0000-4000-8000-000000000003'::uuid, 'DAI-STY-001', 'Daikin Stylish', 'Kompaktes und funktionales Design, das sich in jedes Interieur einfügt. Höchste Effizienz und intelligenter Komfort.', 'b1000000-0000-0000-0000-000000000001'::uuid, 'c1000000-0000-0000-0000-000000000001'::uuid, 1499.00, 19.00, true, 'daikin-stylish'),
  ('a1000000-0000-4000-8000-000000000004'::uuid, 'DAI-EMU-001', 'Daikin Emura', 'Das ultimative Klimagerät in Sachen Design und Technologie. Emura vereint Ästhetik mit herausragender Leistung.', 'b1000000-0000-0000-0000-000000000001'::uuid, 'c1000000-0000-0000-0000-000000000001'::uuid, 1799.00, 19.00, true, 'daikin-emura'),
  ('a1000000-0000-4000-8000-000000000005'::uuid, 'MIT-PRE-001', 'Mitsubishi Heavy Premium', 'Premium-Wandgerät mit höchster Energieeffizienz und fortschrittlichem Allergen-Filter.', 'b1000000-0000-0000-0000-000000000002'::uuid, 'c1000000-0000-0000-0000-000000000001'::uuid, 1299.00, 19.00, true, 'mitsubishi-heavy-premium'),
  ('a1000000-0000-4000-8000-000000000006'::uuid, 'DAI-TRU-001', 'Daikin Truhengerät', 'Ideal für die Installation unter Fenstern. Sorgt für eine optimale Wärmeverteilung im Raum.', 'b1000000-0000-0000-0000-000000000001'::uuid, 'c1000000-0000-0000-0000-000000000002'::uuid, 1299.00, 19.00, true, 'daikin-truhengeraet'),
  ('a1000000-0000-4000-8000-000000000007'::uuid, 'DAI-DEC-001', 'Daikin Deckenkassette', 'Perfekt für abgehängte Decken in gewerblichen Räumen. Bietet eine gleichmäßige Luftverteilung ohne Zugluft.', 'b1000000-0000-0000-0000-000000000001'::uuid, 'c1000000-0000-0000-0000-000000000003'::uuid, 1899.00, 19.00, true, 'daikin-deckenkassette'),
  ('a1000000-0000-4000-8000-000000000008'::uuid, 'MIT-COM-001', 'Mitsubishi Compact', 'Kompaktes Einstiegsmodell für kleinere Räume mit solider Leistung.', 'b1000000-0000-0000-0000-000000000002'::uuid, 'c1000000-0000-0000-0000-000000000004'::uuid, 799.00, 19.00, true, 'mitsubishi-compact')
ON CONFLICT (artikelnummer) DO NOTHING;

-- E2E pricing fixtures (see tests/checkout-pricing.spec.ts).
-- These prove server-side pricing: a discounted article (rabattpreis) and a
...
INSERT INTO lagerbestaende (artikel_id, bestand, mindestbestand) VALUES
  ('a1000000-0000-4000-8000-000000000001'::uuid, 10, 2),
  ('a1000000-0000-4000-8000-000000000002'::uuid, 8, 2),
  ('a1000000-0000-4000-8000-000000000003'::uuid, 5, 2),
  ('a1000000-0000-4000-8000-000000000004'::uuid, 6, 2),
  ('a1000000-0000-4000-8000-000000000005'::uuid, 7, 2),
  ('a1000000-0000-4000-8000-000000000006'::uuid, 4, 2),
...
INSERT INTO artikel_technische_daten (id, artikel_id, inhalt, anzeige_reihenfolge) VALUES
  -- Sensira
  ('a2000000-0000-0000-0000-000000000101'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Energieeffizienz: A++', 1),
  ('a2000000-0000-0000-0000-000000000102'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Raumgröße: bis 30m²', 2),
  ('a2000000-0000-0000-0000-000000000103'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Lautstärke: 21 dB(A)', 3),
  ('a2000000-0000-0000-0000-000000000104'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Kühlleistung: 2.5 kW', 4),
  ('a2000000-0000-0000-0000-000000000105'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Heizleistung: 2.8 kW', 5),
  ('a2000000-0000-0000-0000-000000000106'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Abmessungen: 286 x 770 x 225 mm', 6),
  ('a2000000-0000-0000-0000-000000000107'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Gewicht: 9 kg', 7),
  ('a2000000-0000-0000-0000-000000000108'::uuid, 'a1000000-0000-4000-8000-000000000001'::uuid, 'Kältemittel: R-32', 8),
  -- Perfera
  ('a2000000-0000-0000-0000-000000000201'::uuid, 'a1000000-0000-4000-8000-000000000002'::uuid, 'Energieeffizienz: A+++', 1),
  ('a2000000-0000-0000-0000-000000000202'::uuid, 'a1000000-0000-4000-8000-000000000002'::uuid, 'Raumgröße: bis 40m²', 2),
  ('a2000000-0000-0000-0000-000000000203'::uuid, 'a1000000-0000-4000-8000-000000000002'::uuid, 'Lautstärke: 19 dB(A)', 3),
  ('a2000000-0000-0000-0000-000000000204'::uuid, 'a1000000-0000-4000-8000-000000000002'::uuid, 'Kühlleistung: 3.5 kW', 4),
  ('a2000000-0000-0000-0000-000000000205'::uuid, 'a1000000-0000-4000-8000-000000000002'::uuid, 'Heizleistung: 4.0 kW', 5),
  -- Stylish
  ('a2000000-0000-0000-0000-000000000301'::uuid, 'a1000000-0000-4000-8000-000000000003'::uuid, 'Energieeffizienz: A+++', 1),
  ('a2000000-0000-0000-0000-000000000302'::uuid, 'a1000000-0000-4000-8000-000000000003'::uuid, 'Raumgröße: bis 50m²', 2),
  ('a2000000-0000-0000-0000-000000000303'::uuid, 'a1000000-0000-4000-8000-000000000003'::uuid, 'Lautstärke: 19 dB(A)', 3),
  -- Emura
  ('a2000000-0000-0000-0000-000000000401'::uuid, 'a1000000-0000-4000-8000-000000000004'::uuid, 'Energieeffizienz: A+++', 1),
  ('a2000000-0000-0000-0000-000000000402'::uuid, 'a1000000-0000-4000-8000-000000000004'::uuid, 'Raumgröße: bis 60m²', 2)
