...
-- ============================================
INSERT INTO artikel_technische_daten (artikel_id, schluessel, wert, anzeige_reihenfolge) VALUES
  -- Sensira
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Energieeffizienz', 'A++', 1),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Raumgröße', 'bis 30m²', 2),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Lautstärke', '21 dB(A)', 3),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Kühlleistung', '2.5 kW', 4),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Heizleistung', '2.8 kW', 5),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Abmessungen', '286 x 770 x 225 mm', 6),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Gewicht', '9 kg', 7),
  ('a1000000-0000-0000-0000-000000000001'::uuid, 'Kältemittel', 'R-32', 8),
  -- Perfera
  ('a1000000-0000-0000-0000-000000000002'::uuid, 'Energieeffizienz', 'A+++', 1),
  ('a1000000-0000-0000-0000-000000000002'::uuid, 'Raumgröße', 'bis 40m²', 2),
  ('a1000000-0000-0000-0000-000000000002'::uuid, 'Lautstärke', '19 dB(A)', 3),
  ('a1000000-0000-0000-0000-000000000002'::uuid, 'Kühlleistung', '3.5 kW', 4),
  ('a1000000-0000-0000-0000-000000000002'::uuid, 'Heizleistung', '4.0 kW', 5),
  -- Stylish
  ('a1000000-0000-0000-0000-000000000003'::uuid, 'Energieeffizienz', 'A+++', 1),
  ('a1000000-0000-0000-0000-000000000003'::uuid, 'Raumgröße', 'bis 50m²', 2),
  ('a1000000-0000-0000-0000-000000000003'::uuid, 'Lautstärke', '19 dB(A)', 3),
  -- Emura
  ('a1000000-0000-0000-0000-000000000004'::uuid, 'Energieeffizienz', 'A+++', 1),
  ('a1000000-0000-0000-0000-000000000004'::uuid, 'Raumgröße', 'bis 60m²', 2)
ON CONFLICT (artikel_id, schluessel) DO NOTHING;
